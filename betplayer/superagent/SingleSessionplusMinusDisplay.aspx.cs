...
{
    public partial class SingleSessionplusMinusDisplay : System.Web.UI.Page
    {
        ...
        public DataTable FetchClientData(int AgentID, string AgentCode)
        {
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    string s2 = "Select TotalAmount From SessionCalculation where ClientID = '" + ID + "' and MatchID = '" + MatchID + "' and Session = '"+Sessionname+"'";
