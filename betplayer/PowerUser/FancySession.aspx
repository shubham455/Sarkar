<%@ Page Language="C#" MasterPageFile="~/PowerUser/Dashboard.Master" AutoEventWireup="true" CodeBehind="FancySession.aspx.cs" Inherits="betplayer.PowerUser.FancySession" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div id="main-content">
                            ...
                            <table style="margin: 0px; border-collapse: collapse; padding: 0px;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <button id="btnlockfancy" type="button" class="btn btn-success" style="height: 50px; width: 100px; font-size: large; font-weight: bold; color: black; background-color: #ff6347">Lock</button>
                                        </td>
                                        <td>
                                            <button id="btnUnlockfancy" type="button" class="btn btn-success" style="height: 50px; width: 100px; font-size: large; font-weight: bold; color: black;">UnLock</button>
                                        </td>
                                        <td width="24%" align="left" valign="middle">&nbsp;</td>
                                ...
                                <table>
                                    <tr>
                                        <td style="margin-left: 20px;">
                                            <input id="Over" onkeydown="focusNextElementOnEnterKeyPress(event)" type="text" style="width: 200px; height: 50px; font-size: xx-large; font-weight: bold" name="team1khai" value=""></td>
                                        <td>
        ...
        <script src="js/FancyRateUpdate_v2.13.js"></script>
